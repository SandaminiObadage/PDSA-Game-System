...
-- List of game modules in the coursework
...
-- One row per generated game round
...
-- Execution timing and output details for each algorithm per round
...
-- Player answers submitted for rounds
...
-- Needed by Sixteen Queens duplicate-solution rule
...
-- Optional helper table to mark each algorithm approach used in a game
